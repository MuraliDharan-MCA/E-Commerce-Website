...
function HomePage() {
  ...
  const {fetchFeaturedProducts , isLoading  , products} = userProductStore();
  ...
  return (
    <div className='relative min-h-screen text-white overflow-hidden'>
      ...
      <h1 className='text-center text-5xl sm:text-6xl font-bold text-emerald-400 mb-4'>Expoler Our Categories</h1>
